...
season_birds <- df |> 
  filter(typicalSeason == "Lent") |> 
  mutate(photo_path = as.character(photo_path),
         text = paste0("<b>", comName, "</b><br><i>", birdFamily, "</i><br>", 
                       description, "<br><br>"),
         image = "")
...
season_birds |>
  select(image, text) |>
  kbl(booktabs = T, escape = F, col.names = NULL, longtable = T) |>
  kable_styling(font_size = 12, latex_options = "basic") |>
...
# "
# 
# # putting this in the top of the page
# fam_template <- "### %s {.unlisted}\n"
# 
# # the page layout
# # arguments are:
# # Bird name (title case)
# # Bird picture (40% width)
# # Bird description
# 
# species_template <- 
# "#### %s {.unlisted}
...
#     #   column_spec(1, image = spec_image(birds_in_fam$photo, 20, 20))
#   }
# }
```